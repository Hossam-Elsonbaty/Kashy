...
const BookFilter = () => {
  ...
  return (
    <div className='flex flex-col gap-2'>
      <div className='filter-swiper gap-3.5 border-b border-gray-300 flex items-center p-2 overflow-x-auto whitespace-nowrap max-w-full'>
        <div className='flex items-center p-1 min-w-[webkit-fill-available] gap-3.5'>
